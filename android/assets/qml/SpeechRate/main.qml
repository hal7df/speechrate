...
Rectangle {
    ...
    Button {
        ...
        function startStop()
        {
            ...
            {
                clock.stop();
                clockControl.text = "Start";
                calcOutput.visible = true;
            }
            else
            {
                clock.start();
                clockControl.text = "Stop";
    ...
    Button {
        id: resetButton
        anchors { top: parent.verticalCenter; topMargin: 5; left: parent.left; right: parent.right; bottom: calcOutput.top; bottomMargin: 10 }
        text: "Reset"
        font.pointSize: 16
        onClicked: resetAll()
